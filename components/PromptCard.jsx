   ...
   <div className='prompt_card'>
    <div className='flex justify-between items-start gap-5'>
      <div className='flex-1 flex justify-start items-center gap-3 cursor-pointer'>
        <Image src={post.creator.image} width={40} height={40} className='rounded-full object-contain'></Image>
      ...
      <div className='copy_btn' onClick={handleCopy}>
        <Image src={copied === post.prompt ? `/assets/icons/tick.svg`: `/assets/icons/copy.svg`} width={12} height={12}></Image>
      </div>
    </div>
